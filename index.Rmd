...
1. **Review** DNAnexus architecture and **discuss** useful tools in learning the platform
...
When you specify an app, you will be customizing a file called `dxapp.json`
...
- We can extract values for the different key pairs. 
- We do this with filters
- The following filter extracts
